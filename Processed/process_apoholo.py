"""
Extracts protein and ligand atoms from PDB files in the ApoHolo dataset.
"""
...
def extract_protein_and_ligand(pdb_file_path: str, output_base_path: str) -> None:
    ...
    protein_name = filename.replace("_ligand.pdb", "").replace(".pdb", "")
...
def main() -> None:
    ...
    if len(sys.argv) != 3:
        print("Usage: python process_apoholo.py <protein_folder> <output_folder>")
        sys.exit(1)
